...
const SpecialCrossPieceScene: PackedScene = preload("res://addons/match3_board/demo/pieces/special/special_cross_piece.tscn")
const SpecialShapeConsumerPieceScene: PackedScene = preload("res://addons/match3_board/demo/pieces/special/special_shape_consumer_piece.tscn")
